  ...
  return (
    ...
    >
      ...
      <div className="self-stretch flex flex-col items-start justify-start gap-[30px] max-w-full">
        ...
        <div className="self-stretch flex flex-col items-end justify-start gap-[7px] max-w-full text-3xs text-primary-full">
          <div className="self-stretch flex flex-row items-start justify-start max-w-full">
            <div className="w-[1300px] flex flex-row items-end justify-between py-0 pr-5 pl-0 box-border gap-[20px] max-w-full mq450:flex-wrap">
              <div className="flex flex-col items-start justify-end pt-0 px-0 pb-1">
                <button className="cursor-pointer [border:none] py-2 px-4 bg-primary-full rounded-lg overflow-hidden flex flex-row items-start justify-start whitespace-nowrap z-[1] hover:bg-plum">
                  <div className="relative text-xl font-semibold font-text-sm-bold text-grey-white text-left inline-block min-w-[115px]">
                    Get started
                  </div>
                </button>
              </div>
          ...
          <div className="shadow-[0px_0px_5px_rgba(120,_120,_120,_0.14)] rounded-sm bg-grey-white flex flex-row items-start justify-start p-[3px] whitespace-nowrap z-[1]">
            <div className="relative tracking-[0.04em] leading-[12px] font-medium inline-block min-w-[123px]">
              Go to top (Ctrl+Home)
            </div>
          </div>
        </div>
