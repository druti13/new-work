...
const Testimonials1 = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch bg-grey-white flex flex-row items-start justify-center py-[100px] px-5 box-border shrink-0 max-w-full z-[4] mt-[-33px] text-left text-5xl text-grey-darkest font-text-sm-bold mq750:pb-[65px] mq750:box-border ${className}`}
    >
      <div className="w-[1240px] rounded-lg bg-purple-3 flex flex-col items-start justify-start p-10 box-border gap-[32px] max-w-full mq750:gap-[16px] mq750:pt-[100px] mq750:pb-[26px] mq750:box-border">
        ...
        <div className="flex flex-row items-start justify-start gap-[24px]">
          ...
          <div className="flex flex-col items-start justify-start pt-0.5 px-0 pb-0">
            <h2 className="m-0 relative text-inherit font-semibold font-inherit z-[1] mq450:text-lgi">
              Testimonials
            </h2>
          </div>
        </div>
        <div className="self-stretch flex flex-col items-start justify-start gap-[40px] max-w-full text-lg text-grey-darker mq750:gap-[20px]">
          ...
          <div className="self-stretch flex flex-row items-start justify-start gap-[80px] max-w-full text-xs text-primary-full lg:gap-[40px] mq750:gap-[20px] mq1050:flex-wrap">
